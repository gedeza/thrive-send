...
export default function SharedSegmentsPage() {
  ...
  const getTypeColor = (type: string) => {
    const colors = {
      'CUSTOM': 'text-blue-600 bg-blue-50',
      'BEHAVIORAL': 'text-green-600 bg-green-50',
      'DEMOGRAPHIC': 'text-purple-600 bg-purple-50',
      'GEOGRAPHIC': 'text-orange-600 bg-orange-50',
    };
  ...
  const getEfficiencyColor = (efficiency: string) => {
    ...
    return colors[efficiency as keyof typeof colors] || 'text-gray-600 bg-gray-50';
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Shared Segments</CardTitle>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-2xl font-bold">{stats.totalSharedSegments}</div>
            )}
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-2xl font-bold">{stats.avgUsageCount.toFixed(1)}</div>
            )}
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-2xl font-bold">{stats.highEfficiencyCount}</div>
            )}
